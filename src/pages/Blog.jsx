...
const Blog = () => {
    return (
        <div className='blog lg:flex lg:flex-col lg:gap-y-[50px] my-5'>
            <div className='heading w-full md:w-full flex justify-center items-center h-[10em] lg:h-[10em] border-y lg:border-0 mt-5' >
            ...
            <div className='first w-full flex flex-col lg:flex lg:flex-row my-5 lg:mt-0'>
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, every journey is a story waiting to be captured. From the snowy peaks of Kashmir, the raw beauty of Spiti, to the serene vibes of Himachal, we turn travel into timeless visuals.
            ...
            <div className='third w-full flex flex-col lg:flex lg:flex-row my-5'>
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, short films are where creativity meets storytelling. We bring powerful concepts to life with cinematic visuals, strong emotions, and meaningful narratives.
            ...
            <div className='forth w-full flex flex-col lg:flex lg:flex-row my-5'>
                ...
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, music meets visuals to create pure magic. Our song shoots are crafted with cinematic storytelling, vibrant visuals, and powerful emotions that elevate every beat.
            ...
            <div className='fifth w-full flex flex-col lg:flex lg:flex-row my-5'>
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, we capture spirituality with depth, grace, and reverence. Whether it’s soulful bhajans, serene temple visuals, or spiritual journeys through sacred places — our videos aim to connect hearts and elevate minds.
            ...
            <div className='sixth w-full flex flex-col lg:flex lg:flex-row my-5'>
                ...
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, the magic isn’t just in the final cut — it’s in the journey. Our Behind the Scenes shoots capture the raw, real, and unfiltered moments that happen off-camera.
            ...
            <div className='seventh w-full flex flex-col lg:flex lg:flex-row my-5'>
                <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-5 pt-0'>
                    ...
                    <p className='pt-5 text-justify' >At EPIC MEDIA, we capture the soul of restaurants — the flavors, the ambiance, and the people behind the plate. From cozy cafés to fine dining, our shoots bring out the essence of your space through cinematic visuals and mouthwatering frames.
